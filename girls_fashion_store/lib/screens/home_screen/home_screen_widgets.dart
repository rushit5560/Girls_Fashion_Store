                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                            image: DecorationImage(
                              image: AssetImage(homeScreenController.categoryListImage[index]),
                            )
                        ),
                      ),
                    ),
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        SpacerHeight(15),
        GridView.builder(
          itemCount: homeScreenController.popularProductLists.length,
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: Image(
                                image: AssetImage(homeScreenController
                                    .popularProductLists[index].productImg),
                              ),
                            ),
                            SpacerHeight(10),
                            Text(
                            ...
                            SpacerHeight(3),
                            Text(
                              '\$${homeScreenController.popularProductLists[index].productPrice}',
                              style: TextStyle(
                                fontWeight: FontWeight.bold,
                                color: AppColor.kPinkColor,
                              ),
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          height: 100,
          child: ListView.builder(
            itemCount: homeScreenController.mostSaleList.length,
            scrollDirection: Axis.horizontal,
            itemBuilder: (context, index){
              return Padding(
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                                image: AssetImage(homeScreenController.mostSaleList[index].productImg)
                            ),
                          ),
                        ),
                        SizedBox(width: 10),
                        Column(
                          ...
                          children: [
                            Text(
                              homeScreenController.mostSaleList[index].productName,
                              maxLines: 1,
                              overflow: TextOverflow.ellipsis,
                            ),
                            SpacerHeight(5),
                            ...
                            SpacerHeight(5),
                            Text(
                              '\$${homeScreenController.mostSaleList[index].productPrice}',
                              style: TextStyle(
                                fontWeight: FontWeight.bold,
                                color: AppColor.kPinkColor,
                              ),
